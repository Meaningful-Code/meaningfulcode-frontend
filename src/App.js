  ...
  return (
    <footer>
      <div id='social'>
        ...
        <Button color='twitter' href="https://twitter.com/intent/tweet?source=https%3A%2F%2Fmeaningfulcode.org&text=Pick%20a%20cause%20to%20support%2C%20find%20Open%20Source%20projects%20to%20contribute%20to%2C%20and%20write%2023MeaningfulCode%21%20%E2%9C%A8%20https%3A%2F%2Fmeaningfulcode.org%2F" target="_blank" title="Tweet"><Icon name='twitter' />Twitter</Button>
        <Button color='linkedin' href='http://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fmeaningfulcode.org&title=MeaningfulCode%20-%20Impactful%20open-source&summary=Find%20impactful%20open-source%20projects%2C%20and%20make%20a%20difference&source=https%3A%2F%2Fmeaningfulcode.org' target="_blank" title="Share on LinkedIn"><Icon name='linkedin' />LinkedIn</Button>
        <Button color='red' href="http://www.reddit.com/submit?url=https%3A%2F%2Fmeaningfulcode.org&title=MeaningfulCode%20-%20Impactful%20open-source" target="_blank" title="Submit to Reddit"><Icon name='reddit' />Reddit</Button>
      </div>
    </footer>)
}
...
function GetStarted() {
  return (<>
    ...
    <p>Contributing can be daunting at first, but this is the first step of a rewarding journey, using your experience to benefit others, while learning and meeting new passionate people.</p>

    <Header as='h2'>Every project is different</Header>
    <p>Every project is different, so don't hesitate to look at multiple initiative, to find what makes the most sense to you. Look at the project page and website, issues tagged 'goodfirstissue', and contact them if you have any questions</p>
    <p>You can also check the contribution guidelines when available, or past pull requests, to have a better idea of how the team works, and how to help.</p>

    <Header as='h2'>You don't need to be an expert, all support matters</Header>
    <p>Depending on your goals and expertise, you may very well find yourself outside of your comfort zone. This is perfectly normal, and part of the learning experience. As long as you are motivated to learn and help, maintainers of open source projects are usually happy to help and guide you, to have your contribution integrated.</p>
    <p>Contributing to the code base is also one of many ways to help: some need support translating, improving documentation or tutorials, reviewing, or using it. And the simple act of sharing a project to others is also a great way to help.</p>
    ...
    <ul>
      <li><a href="https://www.firsttimersonly.com/">First timers only: Welcome! Let’s do some open source!</a></li>
      <li><a href="https://alistapart.com/article/make-something-great-become-an-open-source-contributor/">Make Something Great: Become an Open Source Contributor</a></li>
...
function About() {
  return (<>
    ...
    <p>There are many ways to make have an impact on our society, and open source is one of those.
    But finding those impactful projects among all is this challenging, and the open source map is changing every day.
